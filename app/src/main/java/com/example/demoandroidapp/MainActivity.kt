...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val intentData: Bundle? = intent.extras
        if (intentData is Bundle) {
            binding.normalTextview.text = intentData.get("text_value").toString()
        }
    ...
    private fun moveToBasicActivity() {
        val button = findViewById<Button>(R.id.previous_activity_button)
